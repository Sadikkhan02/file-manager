...
git clone https://github.com/sadikkhan02/file-manager.git

Set C++17 Standard: In Visual Studio, follow these steps to set the C++17 standard:

Go to Project > Properties.
Under C/C++, navigate to Language.
Select C++ Language Standard and choose C++17 or C++latest.
Compile & Run: After setting up your project, compile and run the program using the following commands:
